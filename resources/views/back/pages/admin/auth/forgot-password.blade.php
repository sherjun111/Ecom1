...
@section('BoardingHouse',isset($BoardingHouse) ? $BoardingHouse : 'forgot password')
@section('content')
						...
						<div class="login-box bg-white box-shadow border-radius-10">
							...
							<form action="{{ route('admin.send-password-reset-link') }}" method="POST">
                                ...
                                @error('email')
                                <div class="d-block text-dang" style="margin-top: -25px;margin-bottom: 15px;">{{ $message }}</div>
                                @enderror
