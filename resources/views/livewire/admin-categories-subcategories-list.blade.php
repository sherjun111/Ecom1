    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="h4 text-green">Categories</h4>
                    </div>
                        ...
                        <tr data-index="{{ $item->id }}" data-ordering="{{ $item->booking }}">
                               <td>
                                    <div class="avatar mr-2">
                                        <img src="/images/categories/{{ $item->category_image }}" width="75" height="75" alt="">
                                    </div>
                            </td>
                            <td>
                                {{ $item->category_name }}
        ...
        <div class="col-md-12">
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="h4 text-green">Sub Categories</h4>
                    </div>
                    <div class="pull-right">
                        ...
                        <tr data-index="{{ $item->id }}" data-ordering="{{ $item->ordering }}">
                            ...
                            @if ( $item->children->count() > 0 )
                                ...
                                <div class="table-action">
                                    ...
                                    <a href="javascript:;" class="text-danger deleteCategoryBtn" data-id="{{ $item->id }}" data-title="Sub Category">
                                        <i class="dw dw-delete-3"></i>
                                    </a>
                                </div>
                                </td>
