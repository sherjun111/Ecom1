            ...
            <div class="row g-md-4 g-3">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="footer-contain">
                        <ul>
                            <li>
                                <a href="javascript:void(0)" class="text-content">Boarding House</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="text-content">Dorm Nemsu</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="text-content">Product</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="text-content">Foods</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="text-content">Class Schedule</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="text-content">Beauty Section</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-sm-3">
                    ...
                    <div class="footer-contain">
                        <ul>
                            <li>
                                <a href="success.html" class="text-content">Your Booking</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="javascript:void(0)" class="text-content">Track Booking</a>
                            </li>
                            <li>
